...
function setup() {
  ...
  const inimigoTroll = new Inimigo(matrizTroll, imagemTroll, width, 0, 200, 200, 400, 400, 10, 2500)
  const inimigoVoador = new Inimigo(matrizVoador, imagemVoador, width - 52, 200, 100, 75, 200, 150, 10, 1500)
